...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<tr height=28><td colspan=21 bgcolor=#cccccc>'
            +'<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">'
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00; padding:1px;"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;padding:1px;font-size:12px;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_creset" style="font-size:12px;">清除</a></td></tr></table></td></table>'
