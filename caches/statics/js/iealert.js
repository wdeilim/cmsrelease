...
(function($){
	function iealert_initialize($obj, support, title, text){
		...
		$("#goon").unbind('click').click(function(){
			$("#ie-alert-overlay").hide();
			$("#ie-alert-panel").hide();
		});

	}; //end iealert_initialize function
	...
	$.fn.iealert = function(options){
		...
		return this.each(function(){
			if ( $.browser.msie ) {
				var $this = $(this);
				iealert_initialize($this, option.support, option.title, option.text);
			} //if ie
		});
