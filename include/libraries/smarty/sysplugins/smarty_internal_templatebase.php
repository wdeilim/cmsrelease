...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     * @return mixed
     */
    public function jscsssuffix($_output) {
        if (defined('ES_RELEASE')) {
            ...
            if ($matchcss[0]) {
                foreach($matchcss[0] AS $key=>$val) {
                    ...
                    $_output = str_replace($val, str_replace($val_path, $val_path."?vwins_ver=".ES_RELEASE, $val), $_output);
                }
            }
            //js
