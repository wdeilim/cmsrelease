<?php
	...
	$GLOBALS['emoji_other_maps'] = array(
		'names' => array(
			...
			"\xF0\x9F\x8F\xBB" => 'UNKNOWN',
		),
	);


	function emoji_unified_to_null($text){ return str_replace(array_keys($GLOBALS['emoji_other_maps']['names']), '', $text); }
