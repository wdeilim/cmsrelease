<form action="{#$urlarr.now#}" method="post" id="question-edit-form" class="form-information">
    <table id="questioneditform" class="wineditform table-information" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="al-right"><span>问题标题</span></td>
