...
<div class="formfile-content">
    {#ddb_pc set="数据表:library,列表名:lists,显示数目:10,分页显示:1,分页名:pagelist,当前页:{#$page#},分页地址:(fun)__libraryurlpage(null\,(?));,排序:indate desc" where="{#$wheresql#}"#}
    <div style="height:35px;margin-top:-8px;margin-bottom:8px;">
        <div class="formfile-form">
            ...
            <button class="button" onclick="__libraryurlpage(null, 0, $('#formfile-keyval').val());">搜索</button>&nbsp;
    ...
    <div class="appmsg-list cf" id="appmsg-list">
        {#foreach from=$lists item=list#}
                        ...
                        <div class="appmsg-content">
                            ...
                            {#foreach from=string2array($list.setting) item=list2 name=foo#}
                                {#if !empty($smarty.foreach.foo.first)#}
                                    <div class="cover-appmsg-item appmsg-showy" onclick="__libraryurlpage(this);">
                                ...
                                {#else#}
                                    <div class="appmsg-item cf appmsg-showy" onclick="__libraryurlpage(this);">
                                        <img src="{#$list2.img|fillurl#}" alt="{#$list2.title|fillurl#}" class="appmsg-thumb">
                                        <h4 class="appmsg-title"><a href="javascript:void(0)"
                                                                    data-href="{#appurl(0,'library',$list.id,$smarty.foreach.foo.index)#}"
                                                                    target="_blank">{#$list2.title#}</a></h4>
            ...
            {#else#}
                <div id="appmsg-col-{#$list.id#}" class="appmsg-col" data-id="{#$list.id#}">
                    <div class="appmsg appmsg-showy" onclick="__libraryurlpage(this);">
                        <div class="appmsg-content">
                            <h4 class="appmsg-title"><a href="javascript:void(0)"
