...
<div class="formfile-content">
    {#ddb_pc set="数据表:library,列表名:lists,显示数目:10,分页显示:1,分页名:pagelist,当前页:{#$page#},分页地址:(fun)__librarypage(null\,(?));,排序:indate desc" where="{#$wheresql#}"#}
    <div style="height:35px;margin-top:-8px;margin-bottom:8px;">
        <div class="formfile-form">
            ...
            <button class="button" onclick="__librarypage(null, 0, $('#formfile-keyval').val());">搜索</button>&nbsp;
