...
<div class="wrapper">
    ...
    {#include file="menu.tpl" _item=3 _itemp=0#}
    ...
    <div class="main cf custom-menu">
        <div class="mod">
            ...
            <div class="main-bd">
                ...
                <a class="button" style="margin-bottom:15px" href="{#weburl('vip/privilegerelease')#}">发布新特权</a>
                ...
                <table class="table table-primary" id="menu-table">
                    ...
                    {#ddb_pc set="数据表:vip_content,列表名:lists,显示数目:10,分页显示:1,分页名:pagelist,当前页:{#$page#},分页地址:{#$pageurl#}(?)/{#get_get()#},排序:inorder desc>indate desc" where="{#$wheresql#}"#}
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="normal-link" href="{#weburl('vip/privilegestatistics')#}&contentid={#$list.id#}">发放统计</a>
                            <a class="normal-link" href="{#weburl(0,'vip/privilegerelease',$list.id)#}">编辑</a>
