...
<div class="wrapper">
    ...
    {#include file="menu.tpl" _item=6 _itemp=1#}


    <div class="main cf custom-menu">
        <div class="mod">
            <div class="main-bd main-page">
                <h2 class="title">{#$subtitle#}通知</h2>
                            ...
                            <tr>
                                <td>
                                    <div class="control-submit">
                                        ...
                                        <a class="button primary" href="{#weburl('vip/notification')#}">取消</a>
            ...
            $(this).ajaxSubmit({
                ...
                success : function (data) {
                    ...
                    if (data != null && data.success != null && data.success) {
                        $.showModal(data.message, "{#weburl('vip/notification')#}");
                    } else {
