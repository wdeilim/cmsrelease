...
<div class="wrapper">
    ...
    {#include file="menu.tpl" _item=5 _itemp=1#}


    <div class="main cf custom-menu">
        <div class="mod">
            <div class="main-bd main-page">
                <h2 class="title">{#$subtitle#}优惠券</h2>
                ...
                <div class="mod mod-rounded mod-bordered">
                    <form action="{#weburl()#}"  method="post" id="saveform" class="form-services">
                        <table class="table table-form">
                            ...
                            <tr>
                                <td>
                                    <div class="tdtitle">优惠券类型</div>
                                    <div class="row clearfix">
                                        <div class="col-25">
                                            <label><input type="radio" id="type_b1" name="type_b"{#che(value($content,'type_b'), '打折优惠券')#}>打折优惠券（打<input style="width: 30px;" type="text" id="int_a" name="int_a" value="{#value($content,'int_a')#}">折）</label>
                                        </div>
                                        <div class="col-25">
                                            <label><input type="radio" id="type_b2" name="type_b"{#che(value($content,'type_b'), '现金抵用券')#}>现金抵用券（抵用金额<input style="width: 30px;" type="text" id="int_b" name="int_b" value="{#value($content,'int_b')#}">）</label>
                                        </div>
                                    </div>
                                    <div style="margin-top: 8px; color: #999; font-size: 12px;">打折：请填写为0-100的整数，如填入85表示折扣率为8.5折</div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="tdtitle">优惠券数量</div>
                                    每个用户可以获取到<input type="text" name="int_c" id="int_c" class="form-control-tiny" value="{#value($content,'int_c')#}" />
                                    <span>张券</span>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="control-submit">
                                        ...
                                        <a class="button primary" href="{#weburl('vip/coupon')#}">取消</a>
            ...
            $(this).ajaxSubmit({
                ...
                success : function (data) {
                    ...
                    if (data != null && data.success != null && data.success) {
                        $.showModal(data.message, "{#weburl('vip/coupon')#}");
                    } else {
