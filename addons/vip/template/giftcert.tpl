...
<div class="wrapper">
    ...
    {#include file="menu.tpl" _item=4 _itemp=0#}
    ...
    <div class="main cf custom-menu">
        <div class="mod">
            ...
            <div class="main-bd">
                ...
                <a class="button" style="margin-bottom:15px" href="{#weburl('vip/giftcertrelease')#}">发布礼品券</a>
                ...
                <table class="table table-primary" id="menu-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="normal-link" href="{#weburl('vip/giftcertstatistics')#}&contentid={#$list.id#}">发放统计</a>
                            <a class="normal-link" href="{#weburl(0,'vip/giftcertrelease',$list.id)#}">编辑</a>
