...
<div class="wrapper">
    ...
    {#include file="menu.tpl" _item=6 _itemp=0#}
    ...
    <div class="main cf custom-menu">
        <div class="mod">
            ...
            <div class="main-bd">
                ...
                <a class="button" style="margin-bottom:15px" href="{#weburl('vip/notificationrelease')#}">发布新通知</a>
                ...
                <table class="table table-primary" id="menu-table">
                    ...
                    <tr>
                        ...
                        <td class="lt">{#get_html($list.content,25)#}</td>
                        <td>{#$list.indate|date_format:"%Y-%m-%d"#}</td>
                        <td>
                            <a class="normal-link" href="{#weburl(0,'vip/notificationrelease',$list.id)#}">编辑</a>
                ...
                art.dialog({
                    ...
                    button: [{
                        ...
                        callback: function () {
                            $.ajax({
                                type: "POST",
                                url: "{#weburl('vip/notificationdel')#}",
                                data: s,
                                dataType: "json",
                                success: function (msg) {
                                    if (msg.success == "1"){
