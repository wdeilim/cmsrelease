...
<div class="layout">
    <header>
        <img src="{#vippagebanner('privilege', $_A['vip_data']['banner'])#}" class="hd-banner">
    </header>
    <div class="wrap">
            ...
            <li class="item{#isto($list['view'],'0',' red')#}" data-id="{#$list['contentid']#}">
                ...
                <div class="bd">
                    ...
                    <div class="vip-action" id="vip-twocode">
                        ...
                        <div class="vip-qr"><img src="{#appurl('vip/qrcode/privilege')#}&sn={#$list['sn']#}" alt=""></div>
                    </div>
                    ...
                    <div class="vip-usenum">
                        此特权有效期【<span>{#$list.startdate|date_format:"%Y-%m-%d"#}</span>至<span>{#$list.enddate|date_format:"%Y-%m-%d"#}</span>】
                    </div>
    ...
    {#include file="./footer.tpl" _item="1"#}
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("button#butapply").click(function(){
            ...
            var s = "dosubmit=sub&pass="+pass+"&point="+point+"&sn="+sn;
            $.ajax({
                type: "POST",
                url: "{#appurl()#}",
                data: s,
